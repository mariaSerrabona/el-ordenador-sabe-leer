...
def main():
    ...
    inicio_etapa2=etapa2(zonaEscrituraLargoMin, zonaEscrituraLargoMax, zonaEscrituraAnchoMin,zonaEscrituraAnchoMax )

    print('Inicialización de la webcam')

    inicio_etapa2.lectura_etapa2()
